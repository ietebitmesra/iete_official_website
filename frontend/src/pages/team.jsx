...
const Team = () => {
    ...
    return (
    <div id="team" className="relative w-full min-h-screen p-8 overflow-hidden bg-transparent">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="flex items-center mb-12">
          <select
            className="px-4 py-2 text-gray-200 rounded border border-[var(--border)] bg-[var(--panel)] focus:outline-none focus:ring-2 focus:ring-[var(--brand)]"
            value={selectedYear}
    ...
    />
              ...
              <div className="flex space-x-4 mt-auto pt-3">
                <a
                  ...
                  title="Email"
                >
                  <Mail className="w-6 h-6 text-[var(--glow)] group-hover:text-white" />
                </a>
                <a
